...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеДокументовПродажи");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСРеализацией");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСОтчетомПоАктам");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОбслуживаниеКлиентов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСОтчетомПоВыработке");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСОтчетомПоВыработке");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РасчетИВыплатаЗарплаты");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСОтчетомПоЗарплате");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);

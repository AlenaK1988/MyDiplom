...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВКМ_Телеграмм = СписокПодключений.ПолучитьЭлементы().Добавить();
	ВКМ_Телеграмм.Наименование = НСтр("ru='Чаты Telegram'");
	ВКМ_Телеграмм.Активно = -1;
	ВКМ_Телеграмм.Тип = ТипыВнешнихСистем.Телеграм;
